from rl_policy.model.common.normalizer import SingleFieldLinearNormalizer
from rl_policy.common.pytorch_util import dict_apply, dict_apply_reduce, dict_apply_split
import numpy as np
